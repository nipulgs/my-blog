...
### **What about Ubuntu 24.04 LTS?**

-  It’s the latest LTS and will be supported longer (till 2029 standard, 2034 ESM).
    
-  But: Some SIP2 modules might need to be recompiled or manually installed from CPAN because the system Perl version might be too new for older SIP2 scripts.
    
-  Good choice for testing or if you have an experienced admin to manage custom Perl dependencies.
